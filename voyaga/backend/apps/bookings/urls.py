...
urlpatterns = [
    ...
    path('analytics/', views.HostAnalyticsView.as_view()),
    path('wishlist/', views.WishlistView.as_view()),
    path('wishlist/<int:pk>/check/', views.WishlistCheckView.as_view()),
    path('availability/<int:pk>/', views.PropertyAvailabilityView.as_view()),
